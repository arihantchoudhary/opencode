...
const DELIVERY_STEPS = [
  ...
  { icon: GitBranch, label: "CI/CD", sub: "GitHub Actions pipeline" },
      ...
      <section className="max-w-6xl mx-auto px-6 py-24 md:py-32">
        <div className="max-w-2xl">
          ...
          <div className="mt-8 flex gap-3">
              ...
              <a href="https://twitter.com/stardroplin" target="_blank" rel="noopener noreferrer">
                <Button variant="outline" size="lg">
                  <MessageCircle className="mr-1.5 h-4 w-4" /> Tag @stardroplin
                </Button>
              </a>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Tag <strong>@stardroplin</strong> on X with your app idea, or use the dashboard. Plain English — no technical knowledge needed.
              </p>
            </div>
            <div>
              <div className="flex h-9 w-9 items-center justify-center rounded-md border bg-background mb-3">
            ...
            <Card className="border-destructive/20">
              <CardContent className="pt-0">
                <h3 className="font-semibold mb-3 flex items-center gap-2">
                  <XCircle className="h-4 w-4 text-destructive" /> Lovable / Bolt / Replit
                </h3>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2"><XCircle className="h-3.5 w-3.5 text-destructive mt-0.5 shrink-0" /> Generic React template code</li>
                  <li className="flex items-start gap-2"><XCircle className="h-3.5 w-3.5 text-destructive mt-0.5 shrink-0" /> Their hosted sandbox</li>
                  <li className="flex items-start gap-2"><XCircle className="h-3.5 w-3.5 text-destructive mt-0.5 shrink-0" /> No monitoring</li>
                  <li className="flex items-start gap-2"><XCircle className="h-3.5 w-3.5 text-destructive mt-0.5 shrink-0" /> No CI/CD</li>
                  <li className="flex items-start gap-2"><XCircle className="h-3.5 w-3.5 text-destructive mt-0.5 shrink-0" /> Basic email/pass auth</li>
                  <li className="flex items-start gap-2"><XCircle className="h-3.5 w-3.5 text-destructive mt-0.5 shrink-0" /> theirsite.lovable.app</li>
                  <li className="flex items-start gap-2"><XCircle className="h-3.5 w-3.5 text-destructive mt-0.5 shrink-0" /> You&apos;re on your own after</li>
                </ul>
              </CardContent>
            </Card>
      ...
      <section className="border-t bg-zinc-950 text-zinc-100">
        <div className="max-w-6xl mx-auto px-6 py-20 text-center">
          ...
          <p className="text-zinc-400 mb-8 max-w-md mx-auto">
            Tag @stardroplin on X with your app idea, or sign up and describe what you want. We&apos;ll build, deploy, and monitor it.
          </p>
          <div className="flex gap-3 justify-center mb-10">
            ...
            <a href="https://twitter.com/stardroplin" target="_blank" rel="noopener noreferrer">
              <Button size="lg" variant="outline" className="border-zinc-700 text-zinc-300 hover:bg-zinc-800">
                <MessageCircle className="mr-1.5 h-4 w-4" /> @stardroplin
              </Button>
            </a>
          </div>
      ...
      <footer className="border-t">
        <div className="max-w-6xl mx-auto px-6 py-6 flex items-center justify-between text-xs text-muted-foreground">
          ...
          <div className="flex items-center gap-4">
            <a href="https://github.com/arihantchoudhary/opencode" target="_blank" rel="noopener noreferrer" className="hover:text-foreground">
              <GitBranch className="h-3.5 w-3.5" />
            </a>
            <a href="https://twitter.com/stardroplin" target="_blank" rel="noopener noreferrer" className="hover:text-foreground">
