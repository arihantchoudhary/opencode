import { FileDiff, Message, Model, Part, Session, SessionStatus, UserMessage } from "stardrop-sdk/v2"
import { SessionTurn } from "stardrop-ui/session-turn"
import { SessionReview } from "stardrop-ui/session-review"
import { DataProvider } from "stardrop-ui/context"
import { DiffComponentProvider } from "stardrop-ui/context/diff"
import { CodeComponentProvider } from "stardrop-ui/context/code"
import { WorkerPoolProvider } from "stardrop-ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createEffect, createMemo, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "stardrop-ui/logo"
import { IconButton } from "stardrop-ui/icon-button"
import { ProviderIcon } from "stardrop-ui/provider-icon"
import { createDefaultOptions } from "stardrop-ui/pierre"
import { iife } from "stardrop-util/iife"
...
import { Tabs } from "stardrop-ui/tabs"
import { MessageNav } from "stardrop-ui/message-nav"
import { preloadMultiFileDiff, PreloadMultiFileDiffResult } from "@pierre/diffs/ssr"
import { Diff as SSRDiff } from "stardrop-ui/diff-ssr"
import { clientOnly } from "@solidjs/start"
import { type IconName } from "stardrop-ui/icons/provider"
import { Meta, Title } from "@solidjs/meta"
import { Base64 } from "js-base64"

const ClientOnlyDiff = clientOnly(() => import("stardrop-ui/diff").then((m) => ({ default: m.Diff })))
const ClientOnlyCode = clientOnly(() => import("stardrop-ui/code").then((m) => ({ default: m.Code })))
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("stardrop-ui/pierre/worker").then((m) => ({
