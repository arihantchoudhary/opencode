...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new StardropClient()" to fix this error.`)
    }
    return instance
  }
...
export class StardropClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<StardropClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    StardropClient.__registry.set(this, args?.key)
  }
